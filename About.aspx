    ...
    <table class="w-100">
        <tr>
            <td class="image-style">
                <asp:Image ID="Image1" runat="server" Height="378px" ImageUrl="~/Porsche Aesthetic - schöne Autos, diese Porsche 911 GT2 RS.jpeg" Width="291px" />
            </td>
            <td class="content-style">
                ...
                <h2>Contact Us:</h2>
                <h5>Phone Number: +6015487351</h5>
                <h5>Email: AutoFlex@gmail.com</h5>
            </td>
        </tr>
    </table>
</asp:Content>
