<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="AutoFlex.Update" %>
...
&nbsp;</td>
        ...
        <tr>
            <td style="text-align: center" colspan="2" class="auto-style7">
                ...
                <asp:Button ID="BtnUpdate" runat="server" Text="Update" OnClick="BtnUpdate_Click" CssClass="btn btn-primary input-spacing" />
            </td>
        </tr>
    </table>
</asp:Content>
